      ...
      {value => {
        ...
        return (
          <div className="body-section">
            {showLeftNavbar ? displayLeftNavbar() : null}
            {showContent ? displayContent() : null}
            {showRightNavbar ? displayRightNavbar() : null}
          </div>
        )
      }}
    </ConfigurationContext.Consumer>
